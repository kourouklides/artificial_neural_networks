...
* Currently, this repository is neither a library nor a framework, but it is a collection of _code examples_
* The source code is well documented so that it can be used for both _educational purposes_ and for _real-life applications_
* This repository is intended to be friendly to beginners, but it is not limited just to them
* Since TensorFlow is ideal for both _Research_ and _Production Development_, then so is this repository
