...
def main(new_dir=os.getcwd()):
    ...
    parser.add_argument('--autoregressive', type=float, default=1)
    parser.add_argument('--integrated', type=float, default=0)
    parser.add_argument('--moving_average', type=float, default=1)
    ...
    for i in range(1):
        ...
        model_fit.params = [4.76187914e-01, 5.03594751e-04, 0.00000000e+00, 9.40341508e-01, -3.77361530e-01, 4.68511922e+02]
